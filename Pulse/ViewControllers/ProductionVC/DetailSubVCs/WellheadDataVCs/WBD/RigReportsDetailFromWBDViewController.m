...
@interface RigReportsDetailFromWBDViewController ()
{
    BOOL isOut;
    BOOL isEditable;
}
...
@implementation RigReportsDetailFromWBDViewController
...
-(void) viewWillAppear:(BOOL)animated
{
    ...
    if (rigReports.dailyCost == nil) {
        self.lblDailyCost.text = @"-";
    } else {
        self.lblDailyCost.text = [NSString stringWithFormat:@"$%@", rigReports.dailyCost];
    }
    
    if (rigReports.totalCost == nil) {
        self.lblTotalCost.text = @"-";
    } else {
        self.lblTotalCost.text = [NSString stringWithFormat:@"$%@", rigReports.totalCost];
    }
...
- (IBAction)onSelectImage:(UIButton*)sender {
    ...
    for (NSString* imgStr in aryImagesStr) {
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSString *imgStr = rigReports.rigImages[indexPath.row];
