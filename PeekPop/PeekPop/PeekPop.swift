...
/// PeekPop class
@objc public class PeekPop: NSObject {
...
//    @objc open func setViewController(viewController: UIViewController) {
//        self.viewController = viewController
//    }
//    
    ...
    @objc open func registerForPreviewingWithDelegate(_ delegate: PeekPopPreviewingDelegate, sourceView: UIView) -> PreviewingContext {
